...
if __name__ == '__main__':
    img_name = "varias.jpg"  # Cambia esto al nombre correcto de la imagen
    ...
    high_conf_predictions = [res for res in results.boxes if res.conf > 0.5]
    ...
    output_name = f"{img_name}_letras_ajustadas.jpg"
